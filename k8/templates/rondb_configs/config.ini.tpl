...
NumCPUs={{ .Values.configIni.NumCPUs }}
TotalMemoryConfig={{ .Values.configIni.TotalMemoryConfig }}
MaxNoOfTables={{ .Values.configIni.MaxNoOfTables }}
MaxNoOfAttributes={{ .Values.configIni.MaxNoOfAttributes }}
MaxNoOfTriggers={{ .Values.configIni.MaxNoOfTriggers }}
TransactionMemory={{ .Values.configIni.TransactionMemory }}
SharedGlobalMemory={{ .Values.configIni.SharedGlobalMemory }}
RedoBuffer=16M
ReservedConcurrentOperations={{ .Values.configIni.ReservedConcurrentOperations }}
...
FragmentLogFileSize={{ .Values.configIni.FragmentLogFileSize }}
...
MaxNoOfConcurrentOperations={{ .Values.configIni.MaxNoOfConcurrentOperations }}
...
NodeId=65
LocationDomainId=0
HostName=mgmds-0.mgmd.default.svc.cluster.local
PortNumber=1186
NodeActive=1
